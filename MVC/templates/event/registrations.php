...
/**
 * @var array  $event         ข้อมูลกิจกรรม (id, title, location, start_date, max_participants)
 * @var array  $participants  รายชื่อผู้สมัครที่ผ่านการ filter แล้ว
 * @var array  $filterTabs    รายการ tab filter (filter, label, active)
 * @var int    $approvedCount จำนวนคนที่อนุมัติแล้ว
...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-5xl mx-auto px-4 py-8">
        ...
        <!-- Back link -->
        <a href="/event" class="text-sm text-indigo-600 hover:underline mb-4 inline-block">← กลับหน้ากิจกรรมของฉัน</a>
